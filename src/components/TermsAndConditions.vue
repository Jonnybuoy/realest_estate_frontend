<template>
  <div class="container mt-5">
    ...
    <ul>
      ...
      <li><strong>Products:</strong> refer to the products or items offered for sale on the Service.</li>
      <li><strong>Orders:</strong> mean a request by You to purchase Products from Us.</li>
      <li><strong>Promotions:</strong> refer to contests, sweepstakes, or other promotions offered through the Service.</li>
      <li><strong>Service:</strong> refers to the Website.</li>
      <li><strong>Terms and Conditions:</strong> (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions Agreement was generated by TermsFeed Terms and Conditions Generator.</li>
      <li><strong>Third-party Social Media Service:</strong> means any services or content (including data, information, products or services) provided by a third-party that may be displayed, included or made available by the Service.</li>
      <li><strong>Website:</strong> refers to [WEBSITE_NAME], accessible from [WEBSITE_URL]</li>
    ...
    <h4>Your access to and use of the Service is also conditioned on Your acceptance of and compliance with the Privacy Policy of the Company.</h4>
    <p>Our Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your personal information when You use the Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully before using Our Service.</p>
    ...
    <!-- Add other sections of the Terms and Conditions here -->
    ...
    <ul>
      ...
      <!-- Add other content restrictions here -->
    </ul>
    ...
    <h4>Placing Orders for Products</h4>
    ...
    <p>Except as expressly and specifically set forth in this Terms, no representations, statements, consents, waivers, or other acts or omissions shall be deemed a modification of this Terms nor be legally binding, unless documented in physical writing, hand signed by You and a duly appointed officer of the Company.</p>
